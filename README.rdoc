...
A user can search for the properties on post code, and if there is invalid postcode,
  the system would default the search to Sdyney. (The properties listed are in Sydney/Australia. We have not expanded yet .. ;))
